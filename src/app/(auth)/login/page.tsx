    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-indigo-500 rounded-full blur-[128px] opacity-20" />
            </div>
            ...
            <Card className="w-full max-w-md mx-4 relative">
                <CardHeader className="text-center">
                    ...
                    <CardTitle className="text-2xl">Welcome to My CRM</CardTitle>
                    <CardDescription>
                        Sign in to manage your leads, contacts, and sales pipeline
                    </CardDescription>
                </CardHeader>
